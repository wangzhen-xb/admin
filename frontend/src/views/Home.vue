...
import { Users, Shield, FolderOpen, Building2, Home, BarChart3, Settings, User, GitBranch, Globe, Layout, Code2, Atom, Code, MessageSquare, Bell, Mail, FileText, HelpCircle, LogOut, ChevronRight, Calendar, TrendingUp, CheckCircle2, AlertCircle } from 'lucide-vue-next'
...
const projects = ref([
  { name: 'Github', icon: GitBranch, desc: '不要等待机会，而要创造机会。', date: '2021-04-01', status: '开发组' },
  { name: 'Vue', icon: Globe, desc: '现在的你决定将来的你。', date: '2021-04-01', status: '算法组', color: 'green' },
  ...
  { name: 'React', icon: Atom, desc: '健康的身体是实现目标的基石。', date: '2021-04-01', status: '技术组', color: 'cyan' },
  { name: 'JavaScript', icon: Code, desc: '路是走出来的，而不是空想出来的。', date: '2021-04-01', status: '架构组', color: 'yellow' }
])
