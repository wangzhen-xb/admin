...
- Name: login.test.ts >> 登录功能测试 >> 用户名必填验证
- Location: tests\login.test.ts:11:3
...
Error: strict mode violation: locator('.el-message') resolved to 3 elements:
    ...
    3) <div role="alert" id="message_3" class="el-message el-message--warning is-center el-message-fade-enter-active el-message-fade-enter-to">…</div> aka locator('#message_3')
