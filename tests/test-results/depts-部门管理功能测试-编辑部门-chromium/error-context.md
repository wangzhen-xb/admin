...
- Name: depts.test.ts >> 部门管理功能测试 >> 编辑部门
- Location: tests\depts.test.ts:53:3
...
- generic [ref=e6]:
  - generic [ref=e7]:
    - img [ref=e9]
    - heading "欢迎登录" [level=1] [ref=e12]
    - paragraph [ref=e13]: 管理系统
  - generic [ref=e14]:
    - generic [ref=e16]:
      - img [ref=e19]
      - textbox "用户名" [ref=e22]: admin
    - generic [ref=e24]:
      - img [ref=e27]
    ...
    - generic [ref=e38]:
      - generic [ref=e40]:
        ...
        - textbox "验证码" [ref=e45]
      - generic [ref=e46]: "--"
    - button "登 录" [active] [ref=e47] [cursor=pointer]:
      - generic [ref=e48]: 登 录
  - paragraph [ref=e50]: "用户名: admin"
```
