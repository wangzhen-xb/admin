...
- Name: login.test.ts >> 登录功能测试 >> 验证码必填验证
- Location: tests\login.test.ts:30:3
...
Error: strict mode violation: locator('.el-message') resolved to 3 elements:
    ...
    3) <div role="alert" id="message_3" class="el-message el-message--warning is-center el-message-fade-enter-from el-message-fade-enter-active">…</div> aka locator('#message_3')
...
- generic [ref=e1]:
  - generic [ref=e10]:
    ...
    - generic [ref=e18]:
      - generic [ref=e20]:
        - img [ref=e23]
        - textbox "用户名" [ref=e26]: testuser
      - generic [ref=e28]:
        - img [ref=e31]
        - textbox "密码" [ref=e34]: "123456"
        - img [ref=e37]
      - generic [ref=e42]:
        - generic [ref=e44]:
          - img [ref=e47]
  ...
  - alert [ref=e56]:
    - img [ref=e58]
    - paragraph [ref=e60]: 服务器内部错误
  - alert [ref=e61]:
    - img [ref=e63]
    - paragraph [ref=e65]: 获取验证码失败
  - alert [ref=e66]:
    - img [ref=e68]
    - paragraph [ref=e70]: 验证码不能为空
```
